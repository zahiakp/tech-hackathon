...
const supportActions = [
  ...
  { href: "/support/chatbot", title: "Well-being assistant", description: "Explore support options in a guided chat preview.", icon: Bot },
];
...
export default function SupportPage() {
  return (
    <div className="grid gap-6">
      ...
      />
      <PreviewAlert description="Profiles, appointments, messages, and resources are typed preview data. No support backend is connected." />
